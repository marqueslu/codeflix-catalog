...
public class TestApiResponseList<TOutputItem> : TestApiResponse<IList<TOutputItem>>
{
    ...
    public TestApiResponseList(IList<TOutputItem> data) : base(data)
    {
    }

    public TestApiResponseList(IList<TOutputItem> data, TestApiResponseListMeta meta) : base(data)
    {
        Meta = meta;
    }
}
